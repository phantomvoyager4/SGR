  ...
  >
    <div className="flex items-start justify-between mb-5">
      <div
        ...
        style={{
          background: `${color.replace("var(--", "rgba(").replace(")", ", 0.15)")}`,
...
export default function Library() {
  ...
  const dotColor = (t) =>
    ({ teal: "var(--teal)", purple: "var(--purple-2)", yellow: "#FDE047" })[
      t
    ] || "var(--teal)";
  ...
  return (
    <div className="max-w-[1400px] mx-auto fade-up">
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(135deg, rgba(13, 148, 136, 0.08), rgba(139, 92, 246, 0.06))",
          borderColor: "var(--teal-dim)",
        }}
      >
        <div
          className="w-[120px] h-[120px] rounded-xl overflow-hidden border-2 flex-shrink-0"
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-3 mb-2">
            <span
              className="px-3 py-0.5 rounded-full font-mono text-[10px] uppercase tracking-wider font-bold"
              style={{
          ...
          <h1 className="font-display font-black text-[40px] leading-none mb-2">
            {USER.username}
          </h1>
          <div
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-10">
        <StatCard
          ...
          testid="stat-hours"
          label="Czas gry"
          value={USER.totalHours.toLocaleString("pl-PL")}
          suffix="h"
          delta={`+${USER.weekHours}h w tym tygodniu`}
          color="var(--teal)"
        />
        <StatCard
          icon={Gamepad2}
          ...
          delta={`${USER.weekGenreHours}h w tym tygodniu`}
          color="var(--purple-2)"
        />
        <StatCard
          icon={Sparkles}
          testid="stat-recs"
          label="Rekomendacje"
          value={USER.recommendationsCount}
          suffix="wygenerowanych sesji"
          delta={`+${USER.newRecommendations} nowych`}
          color="#FDE047"
        />
      </section>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-8">
        <section data-testid="favorites-section">
          <div className="flex items-end justify-between mb-6">
            <div>
              <h2 className="font-display font-black text-[32px] leading-none mb-1">
                Ulubione
              </h2>
