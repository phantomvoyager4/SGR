...
jsonl_path = os.path.join(base_dir, 'data', 'games_informations', 'example.jsonl')
...
try:
    ...
    output_path = os.path.join(base_dir, 'data', 'parquet_example', 'games_fully_vectorized_example.parquet')
